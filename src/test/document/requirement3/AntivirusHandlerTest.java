...
public class AntivirusHandlerTest {
    ...
    private String applicantName = "Nguyen Van B";
    private String applicantEmail = "nguyenvanb@example.com";
    ...
    private String filePath = "support_test/malware.txt";
    private String fileExtension = "TXT";
    private long fileSizeKB = 1;
    private String digitalSignature = "test-signature";

    @Test
    @DisplayName("Kiểm tra dừng pipeline khi phát hiện virus trong tệp đính kèm")
    void shouldStopWhenVirusDetected() {
        // Arrange: Tạo một tài liệu mẫu với thông tin cá nhân hợp lệ nhưng tệp đính kèm chứa virus
        ...
        assertFalse(result2, "Kiểm tra tệp đính kèm phải thất bại do phát hiện virus");
    }
}
