...
public class DocumentProcessor {
    ...
    public boolean proccessInsertPersonalInfo(Document doc) {
        ...
        // Nếu đang ở trạng thái "Bản nháp"/"Đã tải file" do nhập lại thông tin cá nhân sau khi đã vào trạng thái khác, reset lại chuỗi kiểm tra để đảm bảo các bước kiểm tra được thực hiện đầy đủ khi nhập lại thông tin cá nhân
