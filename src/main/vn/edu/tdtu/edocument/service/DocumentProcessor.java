...
public class DocumentProcessor {
    ...
    private IDocumentValidationStep<PersonalInfoValidationContext> _personalInfoValidationChain; // Chuỗi kiểm tra thông tin người dùng, sẽ được khởi tạo khi cần thiết
    ...
    private IDocumentValidationStep<FileValidationContext> _fileValidationChain; // Chuỗi kiểm tra tệp đính kèm, sẽ được khởi tạo khi cần thiết
